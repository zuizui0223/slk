...
> The code and theory materials needed to reproduce the registered witness regimes and fixation–occupancy verification are available to reviewers at [ANONYMOUS_REVIEW_ARCHIVE_URL].
