...
This is the current submission-oriented manuscript. Relative to V3 it promotes the split logic into a unified critical-surface theorem, places all five separation witnesses inside one convex recovery family, makes cross-level preservation of the endpoint contrast explicit, derives ecological threshold-displacement and conflict–differentiation discordance predictions, adds two-frequency identification plus a three-frequency curvature diagnostic for population feedback, and tightens the accessibility claim to sufficiently small selectively uphill release steps. The process assumptions and empirical claim ceiling are unchanged. The title is 9 words and the abstract is 169 words by the registered checker.
