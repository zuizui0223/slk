...
- `manuscript/SLK_MANUSCRIPT_AMNAT_V4.md` — current journal-facing surface; it promotes the same claim ceiling into the unified critical-surface theorem and one-family witness construction.
